...
class CommonMessage:
    ...
    HELLO_WITHOUT_SUB = (
        ...
        f'Оформляй пробную подписку в разделе {Keyboards.SUBSCRIPTION}\n'
        'Приглашай друзей ведь за друзей мы даем деньги:')
    REFERRAL_INFO_MESSAGE = (
        ...
        '👇 Для запроса на вывод средств — напиши в поддержку (только на карты РФ)!'
    )
    SUBSCRIPTION_WELCOME = (
        'В данный момент у тебя нет активной подписки.🤷‍♂️\n'
        f'Получи пробную подписку на 3 дня в {Keyboards.TRIAL}!🍾\n'
