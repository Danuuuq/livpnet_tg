...
Revision ID: 0eeaeddd1f2b
Revises: 
Create Date: 2025-05-09 19:50:42.120338
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['server_id'], ['region.id'], ),
    sa.ForeignKeyConstraint(['subscription_id'], ['region.id'], ),
    sa.PrimaryKeyConstraint('id'),
